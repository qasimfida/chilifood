import { foodsAr, mealsAr, restaurantPlansAr, restaurantsAr, weekdaysAr } from './select-foodAr';
...
export const foods = [
    ...
    {
        id: '5',
        src: 'https://images.unsplash.com/photo-1574172368358-4898a80133c7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1501&q=80',
        name: 'Delicious Salmon Delight',
        description: 'A mouthwatering dish with amazing flavors.123123',
        macros: [
            { id: '123', name: 'Cal', amount: '112' },
            { id: '124', name: 'Prot', amount: '131' },
    ...
    {
        id: '6',
        src: 'https://images.unsplash.com/photo-1597699401474-e8714c1b7879?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80',
        name: 'Tasty Savory Grilled Salmon Delight',
        description: 'Steak with a side of buttery garlic and mashed potatoes',
        macros: [
            { id: '127', name: 'Cal', amount: '150' },
            { id: '128', name: 'Prot', amount: '90' },
            { id: '129', name: 'Carb', amount: '85' },
    ...
    {
        id: '7',
        src: 'https://images.unsplash.com/photo-1568716508386-cda5cdec6827?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1476&q=80',
        name: 'Another Tasty Dish',
        description: 'A delectable  satisfy your cravings.',
        macros: [
            { id: '127', name: 'Cal', amount: '150' },
            { id: '128', name: 'Prot', amount: '90' },
            { id: '129', name: 'Carb', amount: '85' },
    ...
    {
        id: '8',
        src: 'https://images.unsplash.com/photo-1551326844-4df70f78d0e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1026&q=80',
        name: 'Salmon Delight Tasty Dish',
        description: 'A delectable treat that will cravings.',
        macros: [
            { id: '127', name: 'Cal', amount: '150' },
            { id: '128', name: 'Prot', amount: '90' },
            { id: '129', name: 'Carb', amount: '85' },
